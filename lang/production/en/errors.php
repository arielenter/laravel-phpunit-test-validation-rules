...
return [
    ...
    'incorrect_rule_value' => "Rule given :rule doesn't appear to be a valid "
    . 'rule. Make sure you are using the correct rule name. The validator '
    . 'function returned the following error: :validator_error'
];
